###################################################
### chunk number 1: init-prompt
###################################################
options(prompt= "R> ", continue = "+  ")


###################################################
### chunk number 2: plot-visual-explanation
###################################################
library("dtw")
data("aami3a")
ref <- window(aami3a,start=0,end=2)
test <- window(aami3a,start=2.7,end=5)
plot(dtw(test,ref,k=T),type="two",off=1,match.lty=2,match.indices=20)


###################################################
### chunk number 3: dtw-simple-example
###################################################
library("dtw")
data("aami3a")
ref <- window(aami3a,start=0,end=2)
...
###################################################
### chunk number 4: dtw-normalized-distance
###################################################
...
###################################################
### chunk number 5: symmetric2-step-pattern
###################################################
symmetric2


###################################################
### chunk number 6: plot-symmetric1-step-pattern
###################################################
plot(symmetric1)


###################################################
### chunk number 7: plot-symmetric2-step-pattern
###################################################
plot(symmetric2)


###################################################
### chunk number 8: plot-asymmetric-step-pattern
###################################################
plot(asymmetric)


###################################################
### chunk number 9: plot-rj4c-step-pattern
###################################################
...
###################################################
### chunk number 11: plot-open-begin-end-dtw
###################################################
...
###################################################
### chunk number 12: dtw-multivariate-example
###################################################
query <- cbind(1:10,1)
ref <- cbind(11:15,2)
...
###################################################
### chunk number 13: dtw-multivariate-example2
###################################################
...
###################################################
### chunk number 14: rabiner-exercise-prepare
###################################################
...
###################################################
### chunk number 15: rabiner-exercise-1
###################################################
...
###################################################
### chunk number 16: rabiner-exercise-2
###################################################
...
###################################################
### chunk number 17: costmatrix-figure-code-left eval=FALSE
###################################################
...
###################################################
### chunk number 18: costmatrix-figure-code-right eval=FALSE
###################################################
...
###################################################
### chunk number 19: costmatrix-figure-plot-left
###################################################
lcm <- alignment$localCostMatrix
image(x=1:nrow(lcm),y=1:ncol(lcm),lcm)
text(row(lcm),col(lcm),label=lcm)
...
###################################################
### chunk number 20: costmatrix-figure-plot-right
###################################################
ccm <- alignment$costMatrix
image(x=1:nrow(ccm),y=1:ncol(ccm),ccm)
text(row(ccm),col(ccm),label=ccm)
...
###################################################
### chunk number 21: two-way-plot-code
###################################################
library("dtw")
data("aami3a")
ref <- window(aami3a,start=0,end=2)
...
###################################################
### chunk number 22: three-way-plot
###################################################
